...
func TestCountPathsWithMinimumTime(t *testing.T) {

	t.Run("t1", func(t *testing.T) {
		n := 2
		roads := [][]int{{1, 0, 10}}
		count := leetcode.CountPathsWithMinimumTime(n, roads)
...
func TestCountPathsWithMinimumTimeV2(t *testing.T) {
	...
	t.Run("t4", func(t *testing.T) {
		n := 6
		roads := [][]int{{0, 1, 5}, {0, 2, 1}, {1, 3, 1}, {1, 5, 1}, {2, 3, 2}, {2, 4, 1}, {3, 4, 1}}
		count := leetcode.CountPathsWithMinimumTimeV2(n, roads)
