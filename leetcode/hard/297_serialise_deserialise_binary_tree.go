...
'Amazon', 'Apple', 'Bloomberg', 'Citadel', 'Ebay', 'Expedia', 'Facebook', 'Google', 'Groupon', 'Indeed', 'Linkedin', 'Microsoft', 'Oracle', 'Qualtrics', 'Quora', 'Salesforce', 'Snapchat', 'Tableau', 'Uber', 'Vmware', 'Yahoo'
*/
